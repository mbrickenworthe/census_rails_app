...
aziz = Person.create(name: "Aziz", age: 32, race_number: "E", race: "Indian/Asian", male: true, female: false, admin: false, state: State.find_by(name: "South Carolina"))

sarah = Person.create(name: "Sarah", age: 51, race_number: "A", race: "White", male: false, female: true, admin: false, state: State.find_by(name: "Alaska"))
